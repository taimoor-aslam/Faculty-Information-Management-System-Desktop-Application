...
public class Login extends JFrame implements ActionListener{
    ...
    Login(){
       ...
       icon=new ImageIcon("D:\\BOOKS\\5th SEMESTER\\SC\\PROJECT\\PROJECT IMPLEMENTATION\\Group#1(Faculty Information System)-20191229T155541Z-001\\Group#1(Faculty Information System)\\welcome2.jpg");
       img=new JLabel(icon);
       imgPanel=new JPanel();
       imgPanel.add(img);
